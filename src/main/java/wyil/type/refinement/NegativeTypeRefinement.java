...
public class NegativeTypeRefinement implements TypeRefinement {
	private final TypeSystem typeSystem;

	public NegativeTypeRefinement(TypeSystem typeSystem) {
	...
	private Type refineRecord(Type.Record concrete, Type.Record refinement) throws ResolutionError {
		...
		if(refinement.getFields().size() != fields.size()) {
			// Indicates discrepancy between number of fields in refinement and concrete type.
			return concrete;
		}
